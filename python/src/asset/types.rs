...
impl From<StatementType> for longport::asset::StatementType {
    fn from(value: StatementType) -> Self {
        match value {
            StatementType::Daily => longport::asset::StatementType::Daily,
            StatementType::Monthly => longport::asset::StatementType::Monthly,
        }
    }
}
...
impl From<longport::asset::GetStatementResponse> for GetStatementResponse {
