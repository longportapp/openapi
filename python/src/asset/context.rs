...
use longport::blocking::AssetContextSync;
use pyo3::prelude::*;
...
impl AssetContext {
    ...
    pub fn statements(
        ...
        let opts = longport::asset::GetStatementListOptions::new(statement_type.into())
            .page(start_date)
            .page_size(limit);
    ...
    pub fn statement_download_url(&self, file_key: String) -> PyResult<GetStatementResponse> {
        let opts = longport::asset::GetStatementOptions::new(file_key);
        Ok(self
            .ctx
