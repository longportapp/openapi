...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longport_SdkNative_newAssetContext(
    mut env: JNIEnv,
    _class: JClass,
    config: i64,
) -> i64 {
...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longport_SdkNative_freeAssetContext(
    _env: JNIEnv,
    _class: JClass,
    ctx: i64,
) {
...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longport_SdkNative_assetContextStatements(
    mut env: JNIEnv,
    _class: JClass,
    context: i64,
    opts: JObject,
...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longport_SdkNative_assetContextDownloadUrl(
    mut env: JNIEnv,
    _class: JClass,
    context: i64,
    file_key: JObject,
