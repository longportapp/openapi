...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextGetQuoteLevel(
    mut env: JNIEnv,
    _class: JClass,
    ctx: i64,
    callback: JObject,
...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextGetQuotePackageDetails(
    mut env: JNIEnv,
    _class: JClass,
    ctx: i64,
    callback: JObject,
...
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextSubscribe(
    ...
    jni_result(&mut env, (), |env| {
        ...
        async_util::execute(env, callback, async move {
            Ok(__owned_ctx.subscribe(symbols.0, sub_flags).await?)
        })?;
        Ok(())
    })
}
...
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextUnsubscribe(
    ...
    jni_result(&mut env, (), |env| {
        ...
        let sub_flags = SubFlags::from_bits(flags as u8).unwrap_or(SubFlags::empty());
        async_util::execute(env, callback, async move {
            Ok(__owned_ctx.unsubscribe(symbols.0, sub_flags).await?)
        })?;
        Ok(())
    })
}
...
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextUnsubscribeCandlesticks(
    ...
    jni_result(&mut env, (), |env| {
        ...
        let period: Period = FromJValue::from_jvalue(env, period.into())?;
        async_util::execute(env, callback, async move {
            Ok(__owned_ctx.unsubscribe_candlesticks(symbol, period).await?)
        })?;
        Ok(())
    })
}
...
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextSubscriptions(
    ...
    jni_result(&mut env, (), |env| {
        ...
        let __owned_ctx = context.ctx.clone();
        async_util::execute(env, callback, async move {
            let list = __owned_ctx.subscriptions().await?;
            Ok(ObjectArray(list))
        })?;
        Ok(())
    })
...
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextStaticInfo(
    ...
    jni_result(&mut env, (), |env| {
        ...
        let symbols: ObjectArray<String> =
            FromJValue::from_jvalue(env, JObject::from_raw(symbols).into())?;
        async_util::execute(env, callback, async move {
            let list = __owned_ctx.static_info(symbols.0).await?;
            Ok(ObjectArray(list))
        })?;
        Ok(())
    })
...
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextQuote(
    ...
    jni_result(&mut env, (), |env| {
        ...
        let symbols: ObjectArray<String> =
            FromJValue::from_jvalue(env, JObject::from_raw(symbols).into())?;
        async_util::execute(env, callback, async move {
            let list = __owned_ctx.quote(symbols.0).await?;
            Ok(ObjectArray(list))
        })?;
        Ok(())
    })
...
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextOptionQuote(
    ...
    jni_result(&mut env, (), |env| {
        ...
        let symbols: ObjectArray<String> =
            FromJValue::from_jvalue(env, JObject::from_raw(symbols).into())?;
        async_util::execute(env, callback, async move {
            let list = __owned_ctx.option_quote(symbols.0).await?;
            Ok(ObjectArray(list))
        })?;
        Ok(())
    })
...
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextWarrantQuote(
    ...
    jni_result(&mut env, (), |env| {
        ...
        let symbols: ObjectArray<String> =
            FromJValue::from_jvalue(env, JObject::from_raw(symbols).into())?;
        async_util::execute(env, callback, async move {
            let list = __owned_ctx.warrant_quote(symbols.0).await?;
            Ok(ObjectArray(list))
        })?;
        Ok(())
    })
...
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextDepth(
    ...
    jni_result(&mut env, (), |env| {
        ...
        let symbol: String = FromJValue::from_jvalue(env, symbol.into())?;
        async_util::execute(env, callback, async move {
            Ok(__owned_ctx.depth(symbol).await?)
        })?;
        Ok(())
    })
}
...
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextBrokers(
    ...
    jni_result(&mut env, (), |env| {
        ...
        let symbol: String = FromJValue::from_jvalue(env, symbol.into())?;
        async_util::execute(env, callback, async move {
            Ok(__owned_ctx.brokers(symbol).await?)
        })?;
        Ok(())
    })
}
...
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextParticipants(
    ...
    jni_result(&mut env, (), |env| {
        ...
        let __owned_ctx = context.ctx.clone();
        async_util::execute(env, callback, async move {
            Ok(ObjectArray(__owned_ctx.participants().await?))
        })?;
        Ok(())
    })
}
...
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextTrades(
    ...
    jni_result(&mut env, (), |env| {
        ...
        async_util::execute(env, callback, async move {
            Ok(ObjectArray(
                __owned_ctx.trades(symbol, count.max(0) as usize).await?,
            ))
        })?;
        Ok(())
    })
...
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextIntraday(
    ...
    jni_result(&mut env, (), |env| {
        ...
        async_util::execute(env, callback, async move {
            Ok(ObjectArray(
                __owned_ctx.intraday(symbol, trade_sessions).await?,
            ))
        })?;
        Ok(())
    })
...
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextOptionChainExpiryDateList(
    ...
    jni_result(&mut env, (), |env| {
        ...
        async_util::execute(env, callback, async move {
            Ok(ObjectArray(
                __owned_ctx.option_chain_expiry_date_list(symbol).await?,
            ))
        })?;
        Ok(())
    })
...
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextWarrantIssuers(
    ...
    jni_result(&mut env, (), |env| {
        ...
        let __owned_ctx = context.ctx.clone();
        async_util::execute(env, callback, async move {
            Ok(ObjectArray(__owned_ctx.warrant_issuers().await?))
        })?;
        Ok(())
    })
}
...
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextTradingSession(
    ...
    jni_result(&mut env, (), |env| {
        ...
        let __owned_ctx = context.ctx.clone();
        async_util::execute(env, callback, async move {
            Ok(ObjectArray(__owned_ctx.trading_session().await?))
        })?;
        Ok(())
    })
}
...
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextTradingDays(
    ...
    jni_result(&mut env, (), |env| {
        ...
        async_util::execute(env, callback, async move {
            Ok(__owned_ctx.trading_days(market, begin, end).await?)
        })?;
        Ok(())
    })
}
...
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextCapitalFlow(
    ...
    jni_result(&mut env, (), |env| {
        ...
        let symbol: String = FromJValue::from_jvalue(env, symbol.into())?;
        async_util::execute(env, callback, async move {
            Ok(ObjectArray(__owned_ctx.capital_flow(symbol).await?))
        })?;
        Ok(())
    })
}
...
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextCapitalDistribution(
    ...
    jni_result(&mut env, (), |env| {
        ...
        let symbol: String = FromJValue::from_jvalue(env, symbol.into())?;
        async_util::execute(env, callback, async move {
            Ok(__owned_ctx.capital_distribution(symbol).await?)
        })?;
        Ok(())
    })
}
...
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextWatchlist(
    ...
    jni_result(&mut env, (), |env| {
        ...
        let __owned_ctx = context.ctx.clone();
        async_util::execute(env, callback, async move {
            Ok(ObjectArray(__owned_ctx.watchlist().await?))
        })?;
        Ok(())
    })
}
...
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextDeleteWatchlistGroup(
    ...
    jni_result(&mut env, (), |env| {
        ...
        async_util::execute(env, callback, async move {
            Ok(__owned_ctx.delete_watchlist_group(id, purge).await?)
        })?;
        Ok(())
    })
}
...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextUpdatePinned(
    mut env: JNIEnv,
    _class: JClass,
    context: i64,
    req: JObject,
    ...
    jni_result(&mut env, (), |env| {
        ...
        async_util::execute(env, callback, async move {
            __owned_ctx.update_pinned(mode, symbols.0).await?;
            Ok(())
        })?;
        Ok(())
    })
...
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextRealtimeQuote(
    ...
    jni_result(&mut env, (), |env| {
        ...
        async_util::execute(env, callback, async move {
            Ok(ObjectArray(__owned_ctx.realtime_quote(symbols.0).await?))
        })?;
        Ok(())
    })
}
...
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextRealtimeDepth(
    ...
    jni_result(&mut env, (), |env| {
        ...
        let symbol: String = FromJValue::from_jvalue(env, symbol.into())?;
        async_util::execute(env, callback, async move {
            Ok(__owned_ctx.realtime_depth(symbol).await?)
        })?;
        Ok(())
    })
}
...
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextRealtimeBrokers(
    ...
    jni_result(&mut env, (), |env| {
        ...
        let symbol: String = FromJValue::from_jvalue(env, symbol.into())?;
        async_util::execute(env, callback, async move {
            Ok(__owned_ctx.realtime_brokers(symbol).await?)
        })?;
        Ok(())
    })
}
...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextFilings(
    mut env: JNIEnv,
    _class: JClass,
    context: i64,
    symbol: JObject,
    ...
    jni_result(&mut env, (), |env| {
        ...
        let symbol: String = FromJValue::from_jvalue(env, symbol.into())?;
        async_util::execute(env, callback, async move {
            Ok(ObjectArray(__owned_ctx.filings(symbol).await?))
        })?;
        Ok(())
    })
}
...
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextSecurityList(
    ...
    jni_result(&mut env, (), |env| {
        ...
        async_util::execute(env, callback, async move {
            Ok(ObjectArray(
                __owned_ctx.security_list(market, category).await?,
            ))
        })?;
        Ok(())
    })
...
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextMarketTemperature(
    ...
    jni_result(&mut env, (), |env| {
        ...
        let market: Market = FromJValue::from_jvalue(env, market.into())?;
        async_util::execute(env, callback, async move {
            Ok(__owned_ctx.market_temperature(market).await?)
        })?;
        Ok(())
    })
}
...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextShortPositions(
    mut env: JNIEnv,
    _class: JClass,
    context: i64,
    symbol: JObject,
    ...
    jni_result(&mut env, (), |env| {
        ...
        async_util::execute(env, callback, async move {
            let resp = __owned_ctx.short_positions(symbol, count).await?;
            Ok(resp)
        })?;
        Ok(())
    })
...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextShortTrades(
    mut env: JNIEnv,
    _class: JClass,
    context: i64,
    symbol: JObject,
...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextOptionVolume(
    mut env: JNIEnv,
    _class: JClass,
    context: i64,
    symbol: JObject,
    ...
    jni_result(&mut env, (), |env| {
        ...
        let symbol: String = FromJValue::from_jvalue(env, symbol.into())?;
        async_util::execute(env, callback, async move {
            let resp = __owned_ctx.option_volume(symbol).await?;
            Ok(resp)
        })?;
        Ok(())
    })
...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longport_SdkNative_quoteContextOptionVolumeDaily(
    mut env: JNIEnv,
    _class: JClass,
    context: i64,
    opts: JObject,
