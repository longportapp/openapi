...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longport_SdkNative_newContentContext(
    mut env: JNIEnv,
    _class: JClass,
    config: i64,
) -> i64 {
...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longport_SdkNative_freeContentContext(
    _env: JNIEnv,
    _class: JClass,
    ctx: i64,
) {
...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longport_SdkNative_contentContextMyTopics(
    mut env: JNIEnv,
    _class: JClass,
    context: i64,
    opts: JObject,
...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longport_SdkNative_contentContextCreateTopic(
    mut env: JNIEnv,
    _class: JClass,
    context: i64,
    opts: JObject,
...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longport_SdkNative_contentContextTopics(
    mut env: JNIEnv,
    _class: JClass,
    context: i64,
    symbol: JObject,
...
#[unsafe(no_mangle)]
pub unsafe extern "system" fn Java_com_longport_SdkNative_contentContextNews(
    mut env: JNIEnv,
    _class: JClass,
    context: i64,
    symbol: JObject,
