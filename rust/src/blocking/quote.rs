...
impl QuoteContextSync {
    ...
    /// use std::sync::Arc;
    ///
    /// use longport::{Config, blocking::QuoteContextSync, oauth::OAuthBuilder, quote::SubFlags};
    ///
    /// # fn main() -> Result<(), Box<dyn std::error::Error>> {
    /// let oauth =
    ///     OAuthBuilder::new("your-client-id").build_blocking(|url| println!("Visit: {url}"))?;
    ...
    /// use std::sync::Arc;
    ///
    /// use longport::{Config, blocking::QuoteContextSync, oauth::OAuthBuilder};
    ///
    /// # fn main() -> Result<(), Box<dyn std::error::Error>> {
    /// let oauth =
    ///     OAuthBuilder::new("your-client-id").build_blocking(|url| println!("Visit: {url}"))?;
    ...
    /// use std::sync::Arc;
    ///
    /// use longport::{Config, blocking::QuoteContextSync, oauth::OAuthBuilder, quote::TradeSessions};
    ///
    /// # fn main() -> Result<(), Box<dyn std::error::Error>> {
    /// let oauth =
    ///     OAuthBuilder::new("your-client-id").build_blocking(|url| println!("Visit: {url}"))?;
    ...
    /// use std::sync::Arc;
    ///
    /// use longport::{Config, Market, blocking::QuoteContextSync, oauth::OAuthBuilder};
    /// use time::macros::date;
    ///
    /// # fn main() -> Result<(), Box<dyn std::error::Error>> {
    /// let oauth =
