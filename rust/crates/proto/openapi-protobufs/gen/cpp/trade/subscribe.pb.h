...
PROTOBUF_NAMESPACE_OPEN
template<> ::longbridge::trade::v1::Notification* Arena::CreateMaybeMessage<::longbridge::trade::v1::Notification>(Arena*);
template<> ::longbridge::trade::v1::Sub* Arena::CreateMaybeMessage<::longbridge::trade::v1::Sub>(Arena*);
template<> ::longbridge::trade::v1::SubResponse* Arena::CreateMaybeMessage<::longbridge::trade::v1::SubResponse>(Arena*);
template<> ::longbridge::trade::v1::SubResponse_Fail* Arena::CreateMaybeMessage<::longbridge::trade::v1::SubResponse_Fail>(Arena*);
template<> ::longbridge::trade::v1::Unsub* Arena::CreateMaybeMessage<::longbridge::trade::v1::Unsub>(Arena*);
template<> ::longbridge::trade::v1::UnsubResponse* Arena::CreateMaybeMessage<::longbridge::trade::v1::UnsubResponse>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace longbridge {
namespace trade {
namespace v1 {
...
class Sub final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:longbridge.trade.v1.Sub) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "longbridge.trade.v1.Sub";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:longbridge.trade.v1.Sub)
 private:
  class _Internal;
...
class SubResponse_Fail final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:longbridge.trade.v1.SubResponse.Fail) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "longbridge.trade.v1.SubResponse.Fail";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:longbridge.trade.v1.SubResponse.Fail)
 private:
  class _Internal;
...
class SubResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:longbridge.trade.v1.SubResponse) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "longbridge.trade.v1.SubResponse";
  }
  protected:
  ...
  public:
  void clear_fail();
  ::longbridge::trade::v1::SubResponse_Fail* mutable_fail(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::longbridge::trade::v1::SubResponse_Fail >*
      mutable_fail();
  private:
  const ::longbridge::trade::v1::SubResponse_Fail& _internal_fail(int index) const;
  ::longbridge::trade::v1::SubResponse_Fail* _internal_add_fail();
  public:
  const ::longbridge::trade::v1::SubResponse_Fail& fail(int index) const;
  ::longbridge::trade::v1::SubResponse_Fail* add_fail();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::longbridge::trade::v1::SubResponse_Fail >&
      fail() const;
  ...
  // @@protoc_insertion_point(class_scope:longbridge.trade.v1.SubResponse)
 private:
  class _Internal;
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::longbridge::trade::v1::SubResponse_Fail > fail_;
...
class Unsub final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:longbridge.trade.v1.Unsub) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "longbridge.trade.v1.Unsub";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:longbridge.trade.v1.Unsub)
 private:
  class _Internal;
...
class UnsubResponse final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:longbridge.trade.v1.UnsubResponse) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "longbridge.trade.v1.UnsubResponse";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:longbridge.trade.v1.UnsubResponse)
 private:
  class _Internal;
...
class Notification final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:longbridge.trade.v1.Notification) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "longbridge.trade.v1.Notification";
  }
  protected:
  ...
  ::longbridge::trade::v1::ContentType content_type() const;
  void set_content_type(::longbridge::trade::v1::ContentType value);
  private:
  ::longbridge::trade::v1::ContentType _internal_content_type() const;
  void _internal_set_content_type(::longbridge::trade::v1::ContentType value);
  public:

  // .longbridge.trade.v1.DispatchType dispatch_type = 3 [json_name = "dispatchType"];
  void clear_dispatch_type();
  ::longbridge::trade::v1::DispatchType dispatch_type() const;
  void set_dispatch_type(::longbridge::trade::v1::DispatchType value);
  private:
  ::longbridge::trade::v1::DispatchType _internal_dispatch_type() const;
  void _internal_set_dispatch_type(::longbridge::trade::v1::DispatchType value);
  public:

  // @@protoc_insertion_point(class_scope:longbridge.trade.v1.Notification)
 private:
  class _Internal;
...
inline std::string* Sub::add_topics() {
  ...
  // @@protoc_insertion_point(field_add_mutable:longbridge.trade.v1.Sub.topics)
  return _s;
}
...
inline const std::string& Sub::topics(int index) const {
  // @@protoc_insertion_point(field_get:longbridge.trade.v1.Sub.topics)
  return _internal_topics(index);
}
inline std::string* Sub::mutable_topics(int index) {
  // @@protoc_insertion_point(field_mutable:longbridge.trade.v1.Sub.topics)
  return topics_.Mutable(index);
}
inline void Sub::set_topics(int index, const std::string& value) {
  topics_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:longbridge.trade.v1.Sub.topics)
}
...
inline void Sub::set_topics(int index, const char* value) {
  ...
  topics_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:longbridge.trade.v1.Sub.topics)
}
inline void Sub::set_topics(int index, const char* value, size_t size) {
  topics_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:longbridge.trade.v1.Sub.topics)
}
...
inline void Sub::add_topics(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_add:longbridge.trade.v1.Sub.topics)
}
...
inline void Sub::add_topics(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  topics_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:longbridge.trade.v1.Sub.topics)
}
inline void Sub::add_topics(const char* value, size_t size) {
  topics_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:longbridge.trade.v1.Sub.topics)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
Sub::topics() const {
  // @@protoc_insertion_point(field_list:longbridge.trade.v1.Sub.topics)
  return topics_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
Sub::mutable_topics() {
  // @@protoc_insertion_point(field_mutable_list:longbridge.trade.v1.Sub.topics)
  return &topics_;
}
...
inline const std::string& SubResponse_Fail::topic() const {
  // @@protoc_insertion_point(field_get:longbridge.trade.v1.SubResponse.Fail.topic)
...
void SubResponse_Fail::set_topic(ArgT0&& arg0, ArgT... args) {
 ...
 topic_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:longbridge.trade.v1.SubResponse.Fail.topic)
}
inline std::string* SubResponse_Fail::mutable_topic() {
  std::string* _s = _internal_mutable_topic();
  // @@protoc_insertion_point(field_mutable:longbridge.trade.v1.SubResponse.Fail.topic)
  return _s;
}
...
inline std::string* SubResponse_Fail::release_topic() {
  // @@protoc_insertion_point(field_release:longbridge.trade.v1.SubResponse.Fail.topic)
...
inline void SubResponse_Fail::set_allocated_topic(std::string* topic) {
  ...
  // @@protoc_insertion_point(field_set_allocated:longbridge.trade.v1.SubResponse.Fail.topic)
}
...
inline const std::string& SubResponse_Fail::reason() const {
  // @@protoc_insertion_point(field_get:longbridge.trade.v1.SubResponse.Fail.reason)
...
void SubResponse_Fail::set_reason(ArgT0&& arg0, ArgT... args) {
 ...
 reason_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:longbridge.trade.v1.SubResponse.Fail.reason)
}
inline std::string* SubResponse_Fail::mutable_reason() {
  std::string* _s = _internal_mutable_reason();
  // @@protoc_insertion_point(field_mutable:longbridge.trade.v1.SubResponse.Fail.reason)
  return _s;
}
...
inline std::string* SubResponse_Fail::release_reason() {
  // @@protoc_insertion_point(field_release:longbridge.trade.v1.SubResponse.Fail.reason)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:longbridge.trade.v1.SubResponse.Fail.reason)
}
...
inline std::string* SubResponse::add_success() {
  ...
  // @@protoc_insertion_point(field_add_mutable:longbridge.trade.v1.SubResponse.success)
  return _s;
}
...
inline const std::string& SubResponse::success(int index) const {
  // @@protoc_insertion_point(field_get:longbridge.trade.v1.SubResponse.success)
  return _internal_success(index);
}
inline std::string* SubResponse::mutable_success(int index) {
  // @@protoc_insertion_point(field_mutable:longbridge.trade.v1.SubResponse.success)
...
inline void SubResponse::set_success(int index, const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:longbridge.trade.v1.SubResponse.success)
}
...
inline void SubResponse::set_success(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  success_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:longbridge.trade.v1.SubResponse.success)
}
inline void SubResponse::set_success(int index, const char* value, size_t size) {
  success_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:longbridge.trade.v1.SubResponse.success)
}
...
inline void SubResponse::add_success(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_add:longbridge.trade.v1.SubResponse.success)
}
...
inline void SubResponse::add_success(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  success_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:longbridge.trade.v1.SubResponse.success)
}
inline void SubResponse::add_success(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_add_pointer:longbridge.trade.v1.SubResponse.success)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
SubResponse::success() const {
  // @@protoc_insertion_point(field_list:longbridge.trade.v1.SubResponse.success)
  return success_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
SubResponse::mutable_success() {
  // @@protoc_insertion_point(field_mutable_list:longbridge.trade.v1.SubResponse.success)
  return &success_;
}
...
inline ::longbridge::trade::v1::SubResponse_Fail* SubResponse::mutable_fail(int index) {
  // @@protoc_insertion_point(field_mutable:longbridge.trade.v1.SubResponse.fail)
  return fail_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::longbridge::trade::v1::SubResponse_Fail >*
SubResponse::mutable_fail() {
  // @@protoc_insertion_point(field_mutable_list:longbridge.trade.v1.SubResponse.fail)
  return &fail_;
}
inline const ::longbridge::trade::v1::SubResponse_Fail& SubResponse::_internal_fail(int index) const {
  return fail_.Get(index);
}
inline const ::longbridge::trade::v1::SubResponse_Fail& SubResponse::fail(int index) const {
  // @@protoc_insertion_point(field_get:longbridge.trade.v1.SubResponse.fail)
  return _internal_fail(index);
}
inline ::longbridge::trade::v1::SubResponse_Fail* SubResponse::_internal_add_fail() {
  return fail_.Add();
}
inline ::longbridge::trade::v1::SubResponse_Fail* SubResponse::add_fail() {
  ::longbridge::trade::v1::SubResponse_Fail* _add = _internal_add_fail();
  // @@protoc_insertion_point(field_add:longbridge.trade.v1.SubResponse.fail)
  return _add;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::longbridge::trade::v1::SubResponse_Fail >&
SubResponse::fail() const {
  // @@protoc_insertion_point(field_list:longbridge.trade.v1.SubResponse.fail)
  return fail_;
}
...
inline std::string* SubResponse::add_current() {
  ...
  // @@protoc_insertion_point(field_add_mutable:longbridge.trade.v1.SubResponse.current)
  return _s;
}
...
inline const std::string& SubResponse::current(int index) const {
  // @@protoc_insertion_point(field_get:longbridge.trade.v1.SubResponse.current)
  return _internal_current(index);
}
inline std::string* SubResponse::mutable_current(int index) {
  // @@protoc_insertion_point(field_mutable:longbridge.trade.v1.SubResponse.current)
...
inline void SubResponse::set_current(int index, const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:longbridge.trade.v1.SubResponse.current)
}
...
inline void SubResponse::set_current(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  current_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:longbridge.trade.v1.SubResponse.current)
}
inline void SubResponse::set_current(int index, const char* value, size_t size) {
  current_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:longbridge.trade.v1.SubResponse.current)
}
...
inline void SubResponse::add_current(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_add:longbridge.trade.v1.SubResponse.current)
}
...
inline void SubResponse::add_current(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  current_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:longbridge.trade.v1.SubResponse.current)
}
inline void SubResponse::add_current(const char* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_add_pointer:longbridge.trade.v1.SubResponse.current)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
SubResponse::current() const {
  // @@protoc_insertion_point(field_list:longbridge.trade.v1.SubResponse.current)
  return current_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
SubResponse::mutable_current() {
  // @@protoc_insertion_point(field_mutable_list:longbridge.trade.v1.SubResponse.current)
  return &current_;
}
...
inline std::string* Unsub::add_topics() {
  std::string* _s = _internal_add_topics();
  // @@protoc_insertion_point(field_add_mutable:longbridge.trade.v1.Unsub.topics)
  return _s;
}
...
inline const std::string& Unsub::topics(int index) const {
  // @@protoc_insertion_point(field_get:longbridge.trade.v1.Unsub.topics)
  return _internal_topics(index);
}
inline std::string* Unsub::mutable_topics(int index) {
  // @@protoc_insertion_point(field_mutable:longbridge.trade.v1.Unsub.topics)
  return topics_.Mutable(index);
}
inline void Unsub::set_topics(int index, const std::string& value) {
  topics_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:longbridge.trade.v1.Unsub.topics)
}
...
inline void Unsub::set_topics(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  topics_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:longbridge.trade.v1.Unsub.topics)
}
inline void Unsub::set_topics(int index, const char* value, size_t size) {
  topics_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:longbridge.trade.v1.Unsub.topics)
}
...
inline void Unsub::add_topics(const std::string& value) {
  topics_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:longbridge.trade.v1.Unsub.topics)
}
...
inline void Unsub::add_topics(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  topics_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:longbridge.trade.v1.Unsub.topics)
}
inline void Unsub::add_topics(const char* value, size_t size) {
  topics_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:longbridge.trade.v1.Unsub.topics)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
Unsub::topics() const {
  // @@protoc_insertion_point(field_list:longbridge.trade.v1.Unsub.topics)
  return topics_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
Unsub::mutable_topics() {
  // @@protoc_insertion_point(field_mutable_list:longbridge.trade.v1.Unsub.topics)
  return &topics_;
}
...
inline std::string* UnsubResponse::add_current() {
  std::string* _s = _internal_add_current();
  // @@protoc_insertion_point(field_add_mutable:longbridge.trade.v1.UnsubResponse.current)
  return _s;
}
...
inline const std::string& UnsubResponse::current(int index) const {
  // @@protoc_insertion_point(field_get:longbridge.trade.v1.UnsubResponse.current)
  return _internal_current(index);
}
inline std::string* UnsubResponse::mutable_current(int index) {
  // @@protoc_insertion_point(field_mutable:longbridge.trade.v1.UnsubResponse.current)
  return current_.Mutable(index);
}
inline void UnsubResponse::set_current(int index, const std::string& value) {
  current_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set:longbridge.trade.v1.UnsubResponse.current)
}
...
inline void UnsubResponse::set_current(int index, const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  current_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:longbridge.trade.v1.UnsubResponse.current)
}
inline void UnsubResponse::set_current(int index, const char* value, size_t size) {
  current_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:longbridge.trade.v1.UnsubResponse.current)
}
...
inline void UnsubResponse::add_current(const std::string& value) {
  current_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:longbridge.trade.v1.UnsubResponse.current)
}
...
inline void UnsubResponse::add_current(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  current_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:longbridge.trade.v1.UnsubResponse.current)
}
inline void UnsubResponse::add_current(const char* value, size_t size) {
  current_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:longbridge.trade.v1.UnsubResponse.current)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>&
UnsubResponse::current() const {
  // @@protoc_insertion_point(field_list:longbridge.trade.v1.UnsubResponse.current)
  return current_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField<std::string>*
UnsubResponse::mutable_current() {
  // @@protoc_insertion_point(field_mutable_list:longbridge.trade.v1.UnsubResponse.current)
  return &current_;
}
...
inline const std::string& Notification::topic() const {
  // @@protoc_insertion_point(field_get:longbridge.trade.v1.Notification.topic)
  return _internal_topic();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void Notification::set_topic(ArgT0&& arg0, ArgT... args) {
 ...
 topic_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:longbridge.trade.v1.Notification.topic)
}
inline std::string* Notification::mutable_topic() {
  std::string* _s = _internal_mutable_topic();
  // @@protoc_insertion_point(field_mutable:longbridge.trade.v1.Notification.topic)
  return _s;
}
...
inline std::string* Notification::release_topic() {
  // @@protoc_insertion_point(field_release:longbridge.trade.v1.Notification.topic)
  return topic_.Release();
}
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:longbridge.trade.v1.Notification.topic)
}
...
inline ::longbridge::trade::v1::ContentType Notification::_internal_content_type() const {
  return static_cast< ::longbridge::trade::v1::ContentType >(content_type_);
}
inline ::longbridge::trade::v1::ContentType Notification::content_type() const {
  // @@protoc_insertion_point(field_get:longbridge.trade.v1.Notification.content_type)
  return _internal_content_type();
}
inline void Notification::_internal_set_content_type(::longbridge::trade::v1::ContentType value) {
  
  content_type_ = value;
}
inline void Notification::set_content_type(::longbridge::trade::v1::ContentType value) {
  _internal_set_content_type(value);
  // @@protoc_insertion_point(field_set:longbridge.trade.v1.Notification.content_type)
}
...
inline ::longbridge::trade::v1::DispatchType Notification::_internal_dispatch_type() const {
  return static_cast< ::longbridge::trade::v1::DispatchType >(dispatch_type_);
}
inline ::longbridge::trade::v1::DispatchType Notification::dispatch_type() const {
  // @@protoc_insertion_point(field_get:longbridge.trade.v1.Notification.dispatch_type)
  return _internal_dispatch_type();
}
inline void Notification::_internal_set_dispatch_type(::longbridge::trade::v1::DispatchType value) {
  
  dispatch_type_ = value;
}
inline void Notification::set_dispatch_type(::longbridge::trade::v1::DispatchType value) {
  _internal_set_dispatch_type(value);
  // @@protoc_insertion_point(field_set:longbridge.trade.v1.Notification.dispatch_type)
}
...
inline const std::string& Notification::data() const {
  // @@protoc_insertion_point(field_get:longbridge.trade.v1.Notification.data)
...
void Notification::set_data(ArgT0&& arg0, ArgT... args) {
 ...
 data_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:longbridge.trade.v1.Notification.data)
}
inline std::string* Notification::mutable_data() {
  std::string* _s = _internal_mutable_data();
  // @@protoc_insertion_point(field_mutable:longbridge.trade.v1.Notification.data)
  return _s;
}
...
inline std::string* Notification::release_data() {
  // @@protoc_insertion_point(field_release:longbridge.trade.v1.Notification.data)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:longbridge.trade.v1.Notification.data)
}
...
template <> struct is_proto_enum< ::longbridge::trade::v1::Command> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::longbridge::trade::v1::Command>() {
  return ::longbridge::trade::v1::Command_descriptor();
}
template <> struct is_proto_enum< ::longbridge::trade::v1::DispatchType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::longbridge::trade::v1::DispatchType>() {
  return ::longbridge::trade::v1::DispatchType_descriptor();
}
template <> struct is_proto_enum< ::longbridge::trade::v1::ContentType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::longbridge::trade::v1::ContentType>() {
  return ::longbridge::trade::v1::ContentType_descriptor();
}
