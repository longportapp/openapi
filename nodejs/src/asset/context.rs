...
pub struct AssetContext {
    ctx: longport::asset::AssetContext,
}
...
impl AssetContext {
    ...
    pub fn new(config: &Config) -> AssetContext {
        Self {
            ctx: longport::asset::AssetContext::new(Arc::new(config.0.clone())),
        }
    }
    ...
    pub async fn statements(
        ...
        let mut opts = longport::asset::GetStatementListOptions::new(st);
    ...
    pub async fn statement_download_url(
        ...
        let opts = longport::asset::GetStatementOptions::new(req.file_key);
        Ok(self
            .ctx
